...
(
    ...
    TimeSave date,
    Pc varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci,
    Tablet varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci,
    Mobile varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci,
    Html varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci,
	constraint FK_Url_User foreign key (IdUser) references User(Id)
);

insert into User (Id, Username,Passwords)  values (1, 'admin','123456');
